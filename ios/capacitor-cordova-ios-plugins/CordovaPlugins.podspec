  ...
  Pod::Spec.new do |s|
    ...
    s.source = { :git => 'https://github.com/ionic-team/does-not-exist.git', :tag => '3.3.3' }
    ...
    s.frameworks = 'CoreLocation', 'CoreGraphics', 'AssetsLibrary', 'MobileCoreServices', 'AVFoundation'
  end